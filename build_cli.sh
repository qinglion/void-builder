...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/qinglion/versions/refs/heads/main" # Void

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/qinglion/void-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/qinglion/void/releases" # Void
fi
