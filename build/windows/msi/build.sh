...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="QingLion - Insiders"
  ...
  PRODUCT_NAME="QingLion"
  PRODUCT_CODE="QingLion"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="QingLion-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="QingLion-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
